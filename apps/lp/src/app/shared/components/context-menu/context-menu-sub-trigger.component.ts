...
@Component({
  selector: 'n-context-menu-sub-trigger',
  standalone: true,
  template: `
    <ng-content />
    <svg
...
export class ContextMenuSubTriggerComponent implements OnDestroy {
  ...
  protected readonly classes = computed(() =>
    mergeClasses(
      contextMenuItemVariants({ nVariant: 'default', nInset: this.nInset() }),
