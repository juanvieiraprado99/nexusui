...
export class ComponentsIndexPage {
  protected readonly components: ComponentEntry[] = [
    ...
    { name: 'Pagination', slug: 'pagination', ready: true }, { name: 'Popover', slug: 'popover', ready: true }, { name: 'Progress' },
    ...
    { name: 'Sidebar', slug: 'sidebar', ready: true }, { name: 'Skeleton', slug: 'skeleton', ready: true }, { name: 'Slider', slug: 'slider', ready: true },
