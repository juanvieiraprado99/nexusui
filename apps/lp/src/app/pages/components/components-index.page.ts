...
export class ComponentsIndexPage {
  protected readonly components: ComponentEntry[] = [
    { name: 'Accordion', slug: 'accordion', ready: true }, { name: 'Alert', slug: 'alert', ready: true }, { name: 'Alert Dialog' },
    { name: 'Aspect Ratio' }, { name: 'Avatar', slug: 'avatar', ready: true }, { name: 'Badge', slug: 'badge', ready: true },
    { name: 'Breadcrumb', slug: 'breadcrumb', ready: true }, { name: 'Button', slug: 'button', ready: true }, { name: 'Button Group', slug: 'button-group', ready: true },
    { name: 'Calendar', slug: 'calendar', ready: true }, { name: 'Card', slug: 'card', ready: true }, { name: 'Carousel' },
    { name: 'Chart' }, { name: 'Checkbox', slug: 'checkbox', ready: true }, { name: 'Collapsible', slug: 'collapsible', ready: true },
    { name: 'Combobox', slug: 'combobox', ready: true }, { name: 'Command' }, { name: 'Context Menu', slug: 'context-menu', ready: true },
    { name: 'Data Table', slug: 'data-table', ready: true }, { name: 'Date Picker', slug: 'date-picker', ready: true }, { name: 'Dialog', slug: 'dialog', ready: true },
    { name: 'Drawer', slug: 'drawer', ready: true }, { name: 'Dropdown Menu', slug: 'dropdown-menu', ready: true }, { name: 'Field' },
    { name: 'File Upload', slug: 'file-upload', ready: true },
    { name: 'Form', slug: 'form', ready: true }, { name: 'Hover Card' }, { name: 'Image', slug: 'image', ready: true }, { name: 'Input', slug: 'input', ready: true }, { name: 'Input Group', slug: 'input-group', ready: true },
    { name: 'Input OTP', slug: 'input-otp', ready: true }, { name: 'Item' }, { name: 'Kbd' }, { name: 'Label', slug: 'label', ready: true },
    { name: 'Menubar' }, { name: 'Native Select' }, { name: 'Navigation Menu' },
    { name: 'Pagination', slug: 'pagination', ready: true }, { name: 'Popover', slug: 'popover', ready: true }, { name: 'Progress Bar', slug: 'progress-bar', ready: true },
    ...
    { name: 'Sidebar', slug: 'sidebar', ready: true }, { name: 'Signature', slug: 'signature', ready: true }, { name: 'Skeleton', slug: 'skeleton', ready: true }, { name: 'Slider', slug: 'slider', ready: true },
    { name: 'Sonner', slug: 'sonner', ready: true }, { name: 'Spinner' }, { name: 'Switch', slug: 'switch', ready: true },
    { name: 'Table', slug: 'table', ready: true }, { name: 'Tabs', slug: 'tabs', ready: true }, { name: 'Textarea', slug: 'textarea', ready: true },
