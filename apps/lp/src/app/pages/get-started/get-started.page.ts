...
@Component({
  ...
  imports: [DocsLayoutComponent, RouterLink],
      ...
      <article class="max-w-3xl space-y-16 pb-16">
        ...
        <div class="space-y-4">
          <div class="flex items-center gap-3">
            ...
            <span class="rounded-full border border-border bg-muted px-2.5 py-0.5 text-xs font-medium text-muted-foreground">Angular 21</span>
          </div>
          ...
          <div class="flex items-center gap-3 pt-1">
            ...
            <a
              ...
              class="inline-flex items-center justify-center rounded-md border border-border px-4 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground"
            >
              Installation
            </a>
          </div>
        ...
        <div class="space-y-5">
          ...
          <pre class="rounded-lg bg-zinc-950 p-5 text-xs font-mono leading-relaxed text-zinc-100 overflow-x-auto" aria-label="CLI example"><code><span class="text-zinc-500">$</span> npx @nexuslabs/cli<span class="text-zinc-400">&#64;alpha</span> add combobox

  <span class="text-emerald-400">✓</span> Resolving dependencies...
  <span class="text-emerald-400">✓</span> Installing: combobox <span class="text-zinc-400">→</span> input, label, utils
  <span class="text-emerald-400">✓</span> Transforming imports to your aliases...
  <span class="text-emerald-400">✓</span> Done! 12 files added to src/components/</code></pre>
        ...
        <div class="space-y-5">
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div class="rounded-lg border border-border/60 bg-card p-5 shadow-sm space-y-2">
              <div class="flex h-8 w-8 items-center justify-center rounded-md border border-border/60 bg-muted text-base" aria-hidden="true">⚛️</div>
        ...
        <div class="rounded-lg border border-border/60 bg-card p-6">
          <dl class="grid grid-cols-2 gap-6 sm:grid-cols-4" role="list">
            <div class="text-center">
              <dt class="text-3xl font-bold">18</dt>
        ...
        <!-- Open Source -->
        <div class="rounded-lg border border-border/60 bg-zinc-950 p-8 text-center dark:border-white/10">
